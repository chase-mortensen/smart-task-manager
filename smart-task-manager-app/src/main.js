  ...
  state () {
    return {
      ...
      tasks: [
        ...
        { id: 3, name: 'Read book', type: 'Personal', duration: 45, recurring: true, has_deadline: false, can_be_split: true, person_id: 1, state: 1, isComplete: true, showDetails: false, isScheduled: true, scheduledStartTime: '2021-05-29T19:00:00-07:00', scheduledEndTime: '2021-05-29T20:00:00-07:00' },
